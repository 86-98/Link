...
export const expertiseIcons: { [key: string]: React.ElementType } = {
  ...
  'Applied AI': Sparkles,
  'Dialogue Systems': MessageCircle,
  'AI Platforms': Layers,
  'Speech Recognition': MessageCircle,
  'Interpretability': Eye,
  'Causal Inference': Brain,
  'GPU Technology': Layers,
  'Democratizing AI': Users,
  'Algorithmic Bias': Shield,
  'Existential Risk': Shield,
  'Responsible AI': Shield,
  'AI Theory': Brain,
  'Search Algorithms': Layers,
  'Behavior-based AI': Bot,
  'Embodied AI': Bot,
  'Self-Driving Cars': Bot,
  'Probabilistic Models': Brain,
  'Computational Biology': Brain,
  'AI Leadership': Users,
  'Technology Entrepreneurship': Users,
  'Software Engineering': Layers,
  'Generative Models': Sparkles,
  'Large-Scale Systems': Layers,
  'Machine Learning Infrastructure': Layers,
  'Continual Learning': Repeat,
  'AI for Science': Sparkles,
  'Bayesian Methods': Brain,
  'Human-AI Collaboration': Users,
  'Decision Theory': Brain,
  'Scalable AI': Layers,
  'Optimization': Brain,
  'Sequence Modeling': Layers,
  'AI Entrepreneurship': Users,
  'Search Technology': Layers,
  'European AI': Users,
  'Social Technology': Users,
  'CRM Technology': Layers,
  'Dynamic Control Systems': Bot,
  'AI Hardware': Layers,
  'Fairness in AI': Shield,
  'Social Implications of AI': Shield,
  'Data Studies': Brain,
  'AI Impact': Sparkles,
  'Commonsense Reasoning': Brain,
  'AI Criticism': MessageCircle,
  'National Security': Shield,
  'AI Economics': TrendingUp,
  'Technology Research': Layers,
  'Data Ethics': Shield,
  'AI for Good': Sparkles,
  'Technology Governance': Shield,
  'International Security': Shield,
  'Rationality': Brain,
  'Philosophy of AI': Brain,
  ...
  'Explainable AI': Eye,
  'Interpretable Machine Learning': Eye,
  '3D Computer Vision': Eye,
  'Robot Learning': Bot,
  'Computational Photography': Eye,
  'Graphics': Layers,
  'AI for Creativity': Sparkles,
  'Machine Translation': MessageCircle,
  'Theoretical Machine Learning': Brain,
  'Algorithms': Layers,
  'AI Security': Shield,
...
export const experts: Expert[] = [
  ...
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['Deep Learning', 'Neural Networks', 'Reinforcement Learning'],
    impactArea: 'Pioneers & Foundational Researchers',
    predictions: [],
  ...
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['Deep Learning', 'Neural Networks', 'LSTM'],
    impactArea: 'Pioneers & Foundational Researchers',
    predictions: [],
  ...
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['Machine Learning', 'Statistics', 'AI Theory'],
    impactArea: 'Pioneers & Foundational Researchers',
    predictions: [],
    company: 'UC Berkeley',
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['Artificial Intelligence', 'AI Ethics', 'AI Education'],
    impactArea: 'Pioneers & Foundational Researchers',
    predictions: [],
    company: 'UC Berkeley',
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['Artificial Intelligence', 'AI Education', 'Search Algorithms'],
    impactArea: 'Pioneers & Foundational Researchers',
    predictions: [],
  ...
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['Robotics', 'Behavior-based AI', 'Embodied AI'],
    impactArea: 'Pioneers & Foundational Researchers',
    predictions: [],
  ...
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['Robotics', 'Self-Driving Cars', 'AI Education'],
    impactArea: 'Pioneers & Foundational Researchers',
    predictions: [],
  ...
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['Machine Learning', 'Probabilistic Models', 'Computational Biology', 'AI Education'],
    impactArea: 'Pioneers & Foundational Researchers',
    predictions: [],
  ...
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['Neural Networks', 'Computational Neuroscience', 'Machine Learning'],
    impactArea: 'Pioneers & Foundational Researchers',
    predictions: [],
  ...
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['Computer Vision', 'Machine Learning', 'AI Ethics', 'AI for Good'],
    impactArea: 'Pioneers & Foundational Researchers',
    predictions: [],
  ...
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['AGI Research', 'Neuroscience', 'Machine Learning', 'AI Leadership'],
    impactArea: 'Leaders at Major AI Labs & Companies',
    predictions: [],
  ...
  },
  {
    id: '20',
    name: 'Ilya Sutskever',
    title: 'Co-founder, OpenAI (formerly Chief Scientist)',
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['Deep Learning', 'Neural Networks', 'AGI Research', 'Generative Models'],
    impactArea: 'Leaders at Major AI Labs & Companies',
    predictions: [],
  ...
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['AI Leadership', 'AI Strategy', 'Technology Entrepreneurship'],
    impactArea: 'Leaders at Major AI Labs & Companies',
    predictions: [],
    company: 'OpenAI',
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['AI Leadership', 'Software Engineering', 'AI Strategy'],
    impactArea: 'Leaders at Major AI Labs & Companies',
    predictions: [],
    company: 'OpenAI',
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['Large-Scale Systems', 'Deep Learning', 'Machine Learning Infrastructure'],
    impactArea: 'Leaders at Major AI Labs & Companies',
    predictions: [],
    company: 'Google AI',
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['AGI Research', 'Machine Learning', 'AI Theory'],
    impactArea: 'Leaders at Major AI Labs & Companies',
    predictions: [],
    company: 'Google DeepMind',
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['AI Leadership', 'Applied AI', 'AI Ethics', 'AI Strategy'],
    impactArea: 'Leaders at Major AI Labs & Companies',
    predictions: [],
  ...
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['Reinforcement Learning', 'Dialogue Systems', 'Robotics', 'AI Research'],
    impactArea: 'Leaders at Major AI Labs & Companies',
    predictions: [],
  ...
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['Computer Vision', 'Deep Learning', 'AI Education', 'Neural Networks'],
    impactArea: 'Leaders at Major AI Labs & Companies',
    predictions: [],
  ...
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['Deep Learning', 'Reinforcement Learning', 'Natural Language Processing', 'Sequence Modeling'],
    impactArea: 'Leaders at Major AI Labs & Companies',
    predictions: [],
    company: 'Google DeepMind',
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['Reinforcement Learning', 'Deep Learning', 'Robotics'],
    impactArea: 'Leaders at Major AI Labs & Companies',
    predictions: [],
    company: 'OpenAI',
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['Robotics', 'Generative Models', 'Deep Learning', 'AGI Research'],
    impactArea: 'Leaders at Major AI Labs & Companies',
    predictions: [],
    company: 'OpenAI',
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['Deep Learning', 'Reinforcement Learning', 'Machine Learning'],
    impactArea: 'Leaders at Major AI Labs & Companies',
    predictions: [],
    company: 'Google DeepMind',
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['Robotics', 'Reinforcement Learning', 'Machine Learning', 'Continual Learning'],
    impactArea: 'Leaders at Major AI Labs & Companies',
    predictions: [],
    company: 'Google DeepMind',
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['AI for Science', 'Machine Learning', 'Computer Vision', 'Computational Biology'],
    impactArea: 'Leaders at Major AI Labs & Companies',
    predictions: [],
    company: 'Google DeepMind',
  },
  ...
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['Machine Learning', 'Bayesian Methods', 'AI Research', 'Statistics'],
    impactArea: 'Leaders at Major AI Labs & Companies',
    predictions: [],
  ...
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['Artificial Intelligence', 'Human-AI Collaboration', 'AI Ethics', 'Decision Theory'],
    impactArea: 'Leaders at Major AI Labs & Companies',
    predictions: [],
    company: 'Microsoft',
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['Speech Recognition', 'AI Platforms', 'Machine Learning', 'Natural Language Processing'],
    impactArea: 'Leaders at Major AI Labs & Companies',
    predictions: [],
    company: 'Microsoft',
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['Natural Language Processing', 'Deep Learning', 'Large Language Models'],
    impactArea: 'Leaders at Major AI Labs & Companies',
    predictions: [],
  ...
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['Machine Learning', 'Deep Learning', 'Scalable AI', 'Optimization'],
    impactArea: 'Leaders at Major AI Labs & Companies',
    predictions: [],
  ...
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['Robotics', 'Artificial Intelligence', 'Machine Learning', 'Human-Robot Interaction'],
    impactArea: 'Leaders at Major AI Labs & Companies',
    predictions: [],
  ...
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['Natural Language Processing', 'Transformers', 'Large Language Models', 'AI Entrepreneurship'],
    impactArea: 'Key Innovators & Entrepreneurs',
    predictions: [],
    company: 'Cohere',
  },
  ...
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['Natural Language Processing', 'Transformers', 'Deep Learning', 'AI Entrepreneurship'],
    impactArea: 'Key Innovators & Entrepreneurs',
    predictions: [],
  ...
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['Natural Language Processing', 'Transformers', 'Computational Biology', 'AI Entrepreneurship'],
    impactArea: 'Key Innovators & Entrepreneurs',
    predictions: [],
  ...
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['Natural Language Processing', 'Transformers', 'AI Architectures'],
    impactArea: 'Key Innovators & Entrepreneurs',
    predictions: [],
  ...
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['Blockchain', 'Natural Language Processing', 'Transformers', 'Decentralized Systems'],
    impactArea: 'Pioneers & Foundational Researchers',
    predictions: [],
  ...
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['Deep Learning', 'Natural Language Processing', 'Transformers', 'Machine Learning Systems'],
    impactArea: 'Pioneers & Foundational Researchers',
    predictions: [],
  ...
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['Reinforcement Learning', 'Deep Learning', 'Game AI', 'AGI Research'],
    impactArea: 'Leaders at Major AI Labs & Companies',
    predictions: [],
    company: 'Google DeepMind',
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['Computer Vision', 'Deep Learning', 'Robotics', '3D Reconstruction'],
    impactArea: 'Leaders at Major AI Labs & Companies',
    predictions: [],
  ...
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['Deep Learning', 'Machine Learning', 'AI Education', 'AI Strategy'],
    impactArea: 'Influential Academics',
    predictions: [],
  ...
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['Robotics', 'Reinforcement Learning', 'Deep Learning', 'AI Entrepreneurship'],
    impactArea: 'Influential Academics',
    predictions: [],
  ...
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['Machine Learning', 'Deep Learning', 'Tensor Methods', 'High-Performance Computing'],
    impactArea: 'Influential Academics',
    predictions: [],
  ...
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['Natural Language Processing', 'Trustworthy AI', 'Machine Learning', 'AI Ethics'],
    impactArea: 'Influential Academics',
    predictions: [],
    company: 'Stanford HAI',
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['Natural Language Processing', 'Deep Learning', 'Computational Linguistics'],
    impactArea: 'Influential Academics',
    predictions: [],
  ...
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['Robotics', 'Mobile Computing', 'Distributed Systems', 'AI Leadership'],
    impactArea: 'Influential Academics',
    predictions: [],
    company: 'MIT CSAIL',
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['Natural Language Processing', 'Commonsense Reasoning', 'AI Ethics', 'Computational Linguistics'],
    impactArea: 'Influential Academics',
    predictions: [],
  ...
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['Meta-Learning', 'Reinforcement Learning', 'Robotics', 'Machine Learning'],
    impactArea: 'Influential Academics',
    predictions: [],
    company: 'Stanford University',
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['Computer Vision', 'Self-Driving Cars', 'Machine Learning', 'AI Entrepreneurship'],
    impactArea: 'Influential Academics',
    predictions: [],
  ...
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['Deep Learning', 'Machine Learning', 'Graphical Models', 'AI Research'],
    impactArea: 'Influential Academics',
    predictions: [],
  ...
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['Machine Learning', 'Kernel Methods', 'Causal Inference', 'AI Theory'],
    impactArea: 'Influential Academics',
    predictions: [],
  ...
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['Machine Learning', 'Deep Learning', 'Graphical Models', 'Bayesian Methods'],
    impactArea: 'Influential Academics',
    predictions: [],
  ...
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['Reinforcement Learning', 'Robotics', 'AI Planning', 'Decision Making'],
    impactArea: 'Influential Academics',
    predictions: [],
    company: 'MIT',
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['Machine Learning', 'AI Theory', 'Knowledge Representation'],
    impactArea: 'Influential Academics',
    predictions: [],
  ...
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['Natural Language Processing', 'Word Embeddings', 'Deep Learning'],
    impactArea: 'Influential Academics',
    predictions: [],
  ...
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['Interpretability', 'Explainable AI', 'Machine Learning', 'AI Ethics'],
    impactArea: 'Influential Academics',
    predictions: [],
    company: 'Google DeepMind',
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['Interpretable Machine Learning', 'Causal Inference', 'AI Ethics'],
    impactArea: 'Influential Academics',
    predictions: [],
  ...
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['Robotics', '3D Computer Vision', 'Machine Learning', 'Robot Learning'],
    impactArea: 'Influential Academics',
    predictions: [],
  ...
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['Computer Vision', 'Machine Learning', 'Image Recognition'],
    impactArea: 'Influential Academics',
    predictions: [],
  ...
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['Computer Vision', 'Computational Photography', 'Graphics', 'Machine Learning'],
    impactArea: 'Influential Academics',
    predictions: [],
    company: 'UC Berkeley',
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['Computer Vision', 'Natural Language Processing', 'AI for Creativity', 'Machine Learning'],
    impactArea: 'Influential Academics',
    predictions: [],
  ...
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['Natural Language Processing', 'Machine Translation', 'Deep Learning', 'Neural Networks'],
    impactArea: 'Influential Academics',
    predictions: [],
  ...
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['Theoretical Machine Learning', 'Algorithms', 'Statistics'],
    impactArea: 'Influential Academics',
    predictions: [],
  ...
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['GPU Technology', 'AI Hardware', 'Deep Learning Infrastructure', 'AI Leadership'],
    impactArea: 'Key Innovators & Entrepreneurs',
    predictions: [],
    company: 'NVIDIA',
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['Natural Language Processing', 'Deep Learning', 'Search Technology', 'AI Entrepreneurship'],
    impactArea: 'Key Innovators & Entrepreneurs',
    predictions: [],
  ...
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['Natural Language Processing', 'Open Source AI', 'Democratizing AI', 'AI Entrepreneurship'],
    impactArea: 'Key Innovators & Entrepreneurs',
    predictions: [],
  ...
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['Generative Models', 'GANs', 'Deep Learning', 'AI Security'],
    impactArea: 'Key Innovators & Entrepreneurs',
    predictions: [],
  ...
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['Natural Language Processing', 'Search Technology', 'AI Entrepreneurship', 'Large Language Models'],
    impactArea: 'Key Innovators & Entrepreneurs',
    predictions: [],
  ...
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['Large Language Models', 'AI Entrepreneurship', 'AI Strategy', 'European AI'],
    impactArea: 'Key Innovators & Entrepreneurs',
    predictions: [],
    company: 'Aleph Alpha',
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['Large Language Models', 'AI Entrepreneurship', 'Open Source AI', 'European AI'],
    impactArea: 'Key Innovators & Entrepreneurs',
    predictions: [],
    company: 'Mistral AI',
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['Self-Driving Cars', 'Robotics', 'AI Leadership', 'AI Entrepreneurship'],
    impactArea: 'Key Innovators & Entrepreneurs',
    predictions: [],
  ...
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['AI Platforms', 'Consumer AI', 'Social Technology', 'AI Entrepreneurship'],
    impactArea: 'Key Innovators & Entrepreneurs',
    predictions: [],
    company: 'Quora / Poe',
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['Self-Driving Cars', 'Deep Learning', 'Robotics', 'AI Entrepreneurship'],
    impactArea: 'Key Innovators & Entrepreneurs',
    predictions: [],
    company: 'Wayve',
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['AI Investment', 'Venture Capital', 'Search Technology', 'AI Startups'],
    impactArea: 'Key Innovators & Entrepreneurs',
    predictions: [],
  ...
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['Enterprise AI', 'AI Strategy', 'CRM Technology', 'AI Leadership'],
    impactArea: 'Leaders at Major AI Labs & Companies',
    predictions: [],
  ...
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['Robotics', 'Dynamic Control Systems', 'AI Hardware', 'AI Leadership'],
    impactArea: 'Key Innovators & Entrepreneurs',
    predictions: [],
  ...
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['AI Ethics', 'Algorithmic Bias', 'Fairness in AI', 'AI Policy'],
    impactArea: 'Prominent Voices in AI Ethics & Safety',
    predictions: [],
  ...
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['Algorithmic Bias', 'AI Ethics', 'Facial Recognition Technology', 'AI Policy'],
    impactArea: 'Prominent Voices in AI Ethics & Safety',
    predictions: [],
  ...
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['Social Implications of AI', 'AI Ethics', 'AI Policy', 'Data Studies'],
    impactArea: 'Prominent Voices in AI Ethics & Safety',
    predictions: [],
  ...
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['AI Ethics', 'AI Impact', 'Commonsense Reasoning', 'AI Leadership'],
    impactArea: 'Prominent Voices in AI Ethics & Safety',
    predictions: [],
  ...
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['Cognitive Science', 'Neuro-Symbolic AI', 'AI Criticism', 'AI Safety'],
    impactArea: 'Prominent Voices in AI Ethics & Safety',
    predictions: [],
  ...
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['AI Ethics', 'AI Governance', 'Responsible AI', 'AI Policy'],
    impactArea: 'Prominent Voices in AI Ethics & Safety',
    predictions: [],
    company: 'IBM',
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['Algorithmic Ethics', 'Responsible AI', 'AI Governance', 'AI Policy'],
    impactArea: 'Prominent Voices in AI Ethics & Safety',
    predictions: [],
  ...
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['AI Policy', 'National Security', 'Technology Leadership', 'AI Strategy'],
    impactArea: 'Prominent Voices in AI Ethics & Safety',
    predictions: [],
  ...
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['Societal Impact of AI', 'AI Economics', 'AI Policy', 'Technology Research'],
    impactArea: 'Prominent Voices in AI Ethics & Safety',
    predictions: [],
    company: 'Google',
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['Data Ethics', 'AI for Good', 'Data Science', 'Healthcare AI'],
    impactArea: 'Prominent Voices in AI Ethics & Safety',
    predictions: [],
  ...
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['AI Policy', 'AI Safety', 'Technology Governance', 'International Security'],
    impactArea: 'Prominent Voices in AI Ethics & Safety',
    predictions: [],
  ...
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['AI Alignment', 'Existential Risk', 'AI Safety', 'Rationality'],
    impactArea: 'Prominent Voices in AI Ethics & Safety',
    predictions: [],
  ...
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['AI Safety', 'Existential Risk', 'Superintelligence', 'Philosophy of AI'],
    impactArea: 'Prominent Voices in AI Ethics & Safety',
    predictions: [],
  ...
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['AI Safety', 'Physics', 'Existential Risk', 'Future of AI'],
    impactArea: 'Prominent Voices in AI Ethics & Safety',
    predictions: [],
  ...
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['Game AI', 'Reinforcement Learning', 'Multi-Agent Systems', 'Deep Learning'],
    impactArea: 'Leaders at Major AI Labs & Companies',
    predictions: [],
    company: 'Meta AI',
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['Natural Language Processing', 'Computer Vision', 'Efficient AI Models', 'Machine Learning'],
    impactArea: 'Leaders at Major AI Labs & Companies',
    predictions: [],
    company: 'Meta AI',
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['Reinforcement Learning', 'Deep Learning', 'Neural Networks', 'Game AI'],
    impactArea: 'Leaders at Major AI Labs & Companies',
    predictions: [],
    company: 'Google DeepMind',
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['Speech Recognition', 'Conversational AI', 'Natural Language Processing', 'AI Research'],
    impactArea: 'Leaders at Major AI Labs & Companies',
    predictions: [],
  ...
  },
  {
    ...
    avatarUrl: 'https://placehold.co/400x400.png',
    expertise: ['Deep Learning', 'Speech Recognition', 'Financial AI', 'AI Strategy'],
    impactArea: 'Leaders at Major AI Labs & Companies',
    predictions: [],
