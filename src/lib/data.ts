...
export const experts: Expert[] = [
  ...
  },
  {
    ...
    predictions: [
      {
        id: 'pn-pred-1',
        text: "Focus on Utility, Not Sentience: This is Norvig's most consistent message. He argues that the goal of AI is not to create conscious, thinking beings, but to build useful tools that solve problems. He finds the public and media obsession with whether an AI is \"sentient\" or \"understands\" to be a philosophical distraction from the real work of engineering. The important question is not \"Can it think?\" but \"Can it do useful things for us?\"",
        dateMade: new Date().toISOString(),
        topic: "The Core Philosophy (The Grounded, Utility-First Approach)",
      },
      {
        id: 'pn-pred-2',
        text: "AI is an Engineering Discipline, Not Magic: Similar to Michael I. Jordan, Norvig views the current moment as the maturation of a new engineering field. He is deeply skeptical of hype and \"singularity\" narratives. He predicts that progress will be incremental and driven by practical needs, not a sudden, explosive arrival of superintelligence. It's about solving a series of difficult engineering challenges, not summoning a genie from a bottle.",
        dateMade: new Date().toISOString(),
        topic: "The Core Philosophy (The Grounded, Utility-First Approach)",
      },
      {
        id: 'pn-pred-3',
        text: "The \"AI\" Label is Part of the Problem: Norvig often points out that the term \"Artificial Intelligence\" itself invites anthropomorphism and misplaced expectations. He prefers to talk about machine learning, statistical modeling, or computational tools, which more accurately describe what is actually being built.",
        dateMade: new Date().toISOString(),
        topic: "The Core Philosophy (The Grounded, Utility-First Approach)",
      },
      {
        id: 'pn-pred-4',
        text: "\"The Unreasonable Effectiveness of Data\" Will Continue: This is a concept Norvig championed. He predicts that having massive amounts of data will continue to be more important than having a slightly more clever algorithm. Simple, scalable models fed with internet-scale data have consistently outperformed more complex, theoretically \"smarter\" models with less data. This principle underpins the success of today's LLMs.",
        dateMade: new Date().toISOString(),
        topic: "Technical and Methodological Predictions",
      },
      {
        id: 'pn-pred-5',
        text: "LLMs are Powerful Engineering Tools, Not Proto-AGIs: This is his famous counter-argument to critics like Noam Chomsky. Norvig argues that while LLMs may not \"understand\" language in the same way a human linguist does, they are incredibly effective at manipulating, summarizing, and generating text for practical purposes. To an engineer, if a statistical model of language can write code, translate languages, and answer questions effectively, it is a success. Whether it meets a philosopher's definition of \"understanding\" is irrelevant to its utility. He predicts their usefulness will only grow.",
        dateMade: new Date().toISOString(),
        topic: "Technical and Methodological Predictions",
      },
      {
        id: 'pn-pred-6',
        text: "The Divergence from his Co-Author (Stuart Russell): This is one of the most interesting dynamics in AI. While Russell now focuses on the catastrophic risk posed by flawed AI objectives (the \"King Midas Problem\"), Norvig remains focused on the immediate engineering challenges. He predicts the real-world problems will be about robustness, fairness, and preventing misuse, not about preventing a superintelligence from tiling the universe with paperclips. While he acknowledges long-term risks are worth thinking about, he believes the immediate, practical risks deserve the vast majority of our attention.",
        dateMade: new Date().toISOString(),
        topic: "Technical and Methodological Predictions",
      },
      {
        id: 'pn-pred-7',
        text: "The Real Risks are Practical, Not Existential: Norvig predicts the primary dangers from AI are the ones we can already see and measure:\n\to\tBias: Models trained on biased data will perpetuate and amplify societal inequalities.\n\to\tMisinformation: The ease of creating convincing fake content will pollute the information ecosystem.\n\to\tFairness and Explainability: Making life-altering decisions (e.g., in loans, parole) with \"black box\" systems is a serious societal problem.\n\to\tJob Displacement: Automation will cause significant economic disruption that requires policy solutions.\nHe sees these as difficult but solvable engineering and policy challenges, not as signs of impending doom.",
        dateMade: new Date().toISOString(),
        topic: "Predictions on Societal Impact and Risk",
      },
      {
        id: 'pn-pred-8',
        text: "Education is the Main Bottleneck and Solution: As an educator and textbook author, Norvig believes a primary challenge is the knowledge gap. He predicts a massive need for more people who can not only build these systems but also understand their limitations, use them wisely, and think critically about their outputs. The solution to many of AI's problems is a more educated populace and workforce.",
        dateMade: new Date().toISOString(),
        topic: "Predictions on Societal Impact and Risk",
      },
    ],
  ...
  },
  {
    ...
    predictions: [
      {
        id: 'rb-pred-1',
        text: "True Intelligence Requires a Body: This is his most famous and central thesis, famously summarized by the title of his paper, \"Elephants Don't Play Chess.\" He argues that abstract, disembodied intelligence (like a chess program or an LLM) is a tiny, fragile sliver of what constitutes real intelligence. True understanding and common sense are built \"from the bottom up\" through physical interaction with a messy, unpredictable world. An LLM might \"know\" a banana is slippery, but it doesn't know it in the way a being that has slipped and fallen does.",
        dateMade: new Date().toISOString(),
        topic: "The Core Philosophy (The Embodiment Argument)",
      },
      {
        id: 'rb-pred-2',
        text: "The Physical World is the Real Benchmark, and It's Incredibly Hard: Brooks consistently predicts that the hardest problems in AI are not in abstract domains but in physical reality. He argues that the skills a five-year-old child uses to navigate a room, pick up a toy, or stack blocks are vastly more complex than the skills needed to defeat a grandmaster at Go. He predicts that progress in real-world robotics will continue to be slow, painstaking, and far behind the progress in software domains.",
        dateMade: new Date().toISOString(),
        topic: "The Core Philosophy (The Embodiment Argument)",
      },
      {
        id: 'rb-pred-3',
        text: "AGI is Centuries Away, Not Decades: This is his most prominent and contrarian prediction. Based on the immense difficulty of creating embodied intelligence, he dismisses predictions of AGI arriving in 5, 10, or even 50 years as pure fantasy. He believes we are not even on the right path to AGI because we are largely ignoring the embodiment problem. Progress in LLMs, to him, is not progress on the main road to AGI; it's progress on an interesting side road.",
        dateMade: new Date().toISOString(),
        topic: "The Core Philosophy (The Embodiment Argument)",
      },
      {
        id: 'rb-pred-4',
        text: "Robotics Progress Will Be Incremental and Application-Specific: Don't expect \"Rosie the Robot\" from The Jetsons anytime soon. Brooks predicts that successful robots will continue to be like the Roomba: highly specialized tools that do one thing well in a semi-structured environment. He foresees slow, steady improvement in areas like warehouse logistics and manufacturing, but believes a general-purpose humanoid robot that can navigate an ordinary home and perform varied chores is still the stuff of science fiction.",
        dateMade: new Date().toISOString(),
        topic: "Technical and Engineering Predictions",
      },
      {
        id: 'rb-pred-5',
        text: "LLMs are an Interesting Component, Not the Brain: He doesn't dismiss LLMs entirely. He predicts they will become a useful component in a robot's system, particularly for improving the human-robot interface. You could tell your robot \"go get the red ball from under the table\" and the LLM could translate that into a series of commands for the robot's motor control system. However, he sees the LLM as a \"language front-end,\" not as the core intelligence that understands the world. The real intelligence would be in the perceptual and motor systems.",
        dateMade: new Date().toISOString(),
        topic: "Technical and Engineering Predictions",
      },
      {
        id: 'rb-pred-6',
        text: "The Biggest Risk is Misplaced Expectations and Hype: This is his unique take on \"AI risk.\" He is not worried about a malevolent superintelligence. He is worried that the current hype cycle will lead to massive over-investment in the wrong ideas, followed by a crushing \"AI Winter\" when the promised AGI fails to materialize. He predicts this bubble of inflated expectations will damage the field, disappoint the public, and waste billions of dollars.",
        dateMade: new Date().toISOString(),
        topic: "Predictions on Societal Impact and Risk",
      },
      {
        id: 'rb-pred-7',
        text: "He Dismisses \"Existential Risk\" Scenarios as Ill-Conceived Fantasy: Brooks is one of the most vocal critics of the \"paperclip maximizer\" and \"Skynet\" scenarios. He argues these thought experiments demonstrate a profound lack of imagination about the realities of the physical world. An AI in a server farm cannot magically build robot armies or tile the universe with paperclips. It would need to solve the incredibly hard problems of mining, refining, manufacturing, supply chains, and energy production, all while interacting with a physical world it has no innate understanding of. To him, the existential risk narrative is a \"story for children\" that ignores real-world engineering constraints.",
        dateMade: new Date().toISOString(),
        topic: "Predictions on Societal Impact and Risk",
      },
    ],
  ...
  },
  {
    ...
    predictions: [
      {
        id: 'st-pred-1',
        text: "AI's Purpose is to Grant Humans \"Superpowers\": This is his central, optimistic vision. He predicts AI will not replace humans but augment them, making them better at their jobs and lives. A doctor assisted by an AI diagnostician becomes a \"super-doctor.\" A student with an AI tutor gets a \"super-education.\" His focus is consistently on using technology to elevate human capability.",
        dateMade: new Date().toISOString(),
        topic: "Core Philosophy (The Application-First, Optimistic View)",
      },
      {
        id: 'st-pred-2',
        text: "The Future Must Be Built, Not Just Debated: Thrun has little patience for purely philosophical debates about long-term AI risk that are disconnected from building real systems. He believes that true understanding and progress come from trying to build things, failing, and iterating. His career—from building the self-driving car Stanley to creating Google Glass to launching Udacity—is a testament to his belief that the best way to predict the future is to invent it.",
        dateMade: new Date().toISOString(),
        topic: "Core Philosophy (The Application-First, Optimistic View)",
      },
      {
        id: 'st-pred-3',
        text: "Democratization of Knowledge is the Most Powerful Force: This is the core thesis behind Udacity. Thrun predicts that the most significant societal impact of AI will come not from a few elite labs, but from empowering millions of people around the globe with the skills to build their own AI applications. The real bottleneck to progress isn't technology; it's the availability of trained talent. He sees accessible, affordable education as the key to unlocking a global wave of innovation.",
        dateMade: new Date().toISOString(),
        topic: "Core Philosophy (The Application-First, Optimistic View)",
      },
      {
        id: 'st-pred-4',
        text: "Autonomous Systems Will Radically Reshape the Physical World: Having kickstarted the self-driving revolution, Thrun predicts its effects will be profound. This goes beyond personal convenience. He foresees:\n\to\tRedesigned Cities: Vast areas currently used for parking will be reclaimed for parks and housing.\n\to\tVastly Increased Safety: The eventual elimination of the 1.3 million annual deaths from human-driver-caused car accidents.\n\to\tRevolutionized Logistics: Fully autonomous trucking and delivery will reshape commerce and supply chains.",
        dateMade: new Date().toISOString(),
        topic: "Predictions on Technology and its Real-World Impact",
      },
      {
        id: 'st-pred-5',
        text: "AI Will Transform Healthcare and Education: These are two of his key targets.\n\to\tIn Healthcare: He predicts that AI-powered diagnostic tools (e.g., for detecting cancer in medical images) will become cheaper, more accessible, and often more accurate than human specialists, bringing high-quality diagnosis to underserved parts of the world.\n\to\tIn Education: He predicts a shift away from the one-size-fits-all classroom model towards personalized AI tutors that adapt to each student's unique learning pace and style, making education more effective and engaging.",
        dateMade: new Date().toISOString(),
        topic: "Predictions on Technology and its Real-World Impact",
      },
      {
        id: 'st-pred-6',
        text: "Rapid Iteration with Real-World Data is How Progress is Made: Thrun's methodology is grounded in the \"learning loop.\" He predicts that the most successful AI systems will be those that are deployed into the world (even if imperfectly), collect massive amounts of data, and use that data to improve themselves rapidly. This iterative, data-driven approach is more powerful than trying to design a theoretically perfect system in a lab.",
        dateMade: new Date().toISOString(),
        topic: "Predictions on Technology and its Real-World Impact",
      },
      {
        id: 'st-pred-7',
        text: "Risks are Real but are Solvable Engineering and Policy Challenges: He is not blind to the downsides. He recognizes the risks of accidents with autonomous cars, job displacement from automation, and algorithmic bias. However, he views these not as existential threats or reasons to stop, but as bugs to be fixed and challenges to be overcome through better engineering, thoughtful regulation, and social safety nets.",
        dateMade: new Date().toISOString(),
        topic: "His Stance on Risk and Society",
      },
      {
        id: 'st-pred-8',
        text: "The Greatest Risk of All is Inaction: This is his powerful counter-argument to the AI pessimists. Thrun would predict that the moral failure would be to not pursue AI vigorously. To him, slowing down or stopping means willingly accepting millions of preventable deaths from car accidents and disease, leaving millions without access to quality education, and foregoing solutions to grand challenges like climate change. He believes we have a moral imperative to push forward.",
        dateMade: new Date().toISOString(),
        topic: "His Stance on Risk and Society",
      },
    ],
  ...
  },
  {
    ...
    predictions: [
      {
        id: 'dk-pred-1',
        text: "Correlation is Not Enough; We Need Causality: This is her central thesis. While Large Language Models and other deep learning systems are brilliant at finding correlations in massive datasets, this is insufficient and often dangerous for scientific discovery and medicine. Giving someone a drug because their data correlates with people who responded well is not the same as knowing the drug causes a beneficial effect via a specific biological pathway. She predicts that the next frontier of AI will be in building models that understand cause and effect.",
        dateMade: new Date().toISOString(),
        topic: "The Core Philosophy (The Argument for Structure and Causality)",
      },
      {
        id: 'dk-pred-2',
        text: "The Future is Hybrid Models: She predicts that the most powerful AI systems will not be \"pure\" deep learning or \"pure\" symbolic models. Instead, they will be hybrids that combine the pattern-recognition strengths of deep learning with the structured, causal reasoning of frameworks like Probabilistic Graphical Models (PGMs), which was her primary research area. This allows you to embed known scientific knowledge (e.g., a gene's function) into the model, making it more robust, data-efficient, and interpretable.",
        dateMade: new Date().toISOString(),
        topic: "The Core Philosophy (The Argument for Structure and Causality)",
      },
      {
        id: 'dk-pred-3',
        text: "Black Boxes are Unacceptable in High-Stakes Domains: Koller argues forcefully that in fields like medicine, a \"black box\" that gives an answer without an explanation is not just unhelpful, it's irresponsible. A doctor needs to know why the AI recommends a certain treatment. She predicts a major push towards interpretable AI (XAI), where the models can expose their reasoning, allowing human experts to validate, trust, and ultimately take responsibility for the final decision.",
        dateMade: new Date().toISOString(),
        topic: "The Core Philosophy (The Argument for Structure and Causality)",
      },
      {
        id: 'dk-pred-4',
        text: "The Rise of the \"In-Silico\" Lab to Predict Biology: This is the mission of her company, Insitro. Koller predicts that AI will allow us to create high-fidelity computational models of human biology. Instead of years of slow, expensive \"wet lab\" experiments, we will be able to run millions of virtual experiments \"in-silico\" (on a computer) to predict how a specific disease will progress or how a potential drug will affect cells.",
        dateMade: new Date().toISOString(),
        topic: "Predictions on Technology's Application (The AI-Driven Lab)",
      },
      {
        id: 'dk-pred-5',
        text: "Closing the Loop: AI-Driven Experimentation: She doesn't just predict better data analysis; she predicts a revolution in the scientific method itself. The future lab will operate in a tight loop:\n\to\tAI models analyze existing biological data to generate a causal hypothesis.\n\to\tRobotics in a high-throughput \"wet lab\" automatically conduct the specific experiment needed to test that hypothesis.\n\to\tThe new data from the experiment is fed back into the AI model, which refines its understanding and generates the next hypothesis.\nThis AI-driven cycle will vastly accelerate the pace of scientific discovery.",
        dateMade: new Date().toISOString(),
        topic: "Predictions on Technology's Application (The AI-Driven Lab)",
      },
      {
        id: 'dk-pred-6',
        text: "A Shift from Population-Level to Personalized Medicine: The ultimate goal of this work is true personalization. She predicts that we will move away from treating \"the average patient\" and towards a model where AI can integrate an individual's unique genetics, environment, and lifestyle data to predict their specific disease trajectory and tailor the optimal intervention just for them.",
        dateMade: new Date().toISOString(),
        topic: "Predictions on Technology's Application (The AI-Driven Lab)",
      },
      {
        id: 'dk-pred-7',
        text: "The Real Risk is Flawed, Uninterpretable Models Causing Harm: Koller's view of risk is not about Skynet; it's profoundly practical. The danger she worries about is an AI model confidently recommending the wrong drug, leading to patient death, or halting a promising drug trial because of a data artifact. Her focus is on the critical need for validation, robustness, and safety in systems that make life-or-death decisions.",
        dateMade: new Date().toISOString(),
        topic: "Stance on Risk and Society (The Need for Trust and Education)",
      },
      {
        id: 'dk-pred-8',
        text: "The Solution is Interdisciplinary Education: Having co-founded Coursera, Koller is a firm believer in the power of education. She predicts that the biggest breakthroughs will come from people who are \"bilingual\"—fluent in both machine learning and a specific domain like biology, chemistry, or medicine. She advocates for breaking down academic silos and training a new generation of scientists and engineers who can bridge these worlds and build trustworthy AI systems for science.",
        dateMade: new Date().toISOString(),
        topic: "Stance on Risk and Society (The Need for Trust and Education)",
      },
    ],
  ...
  },
  {
    ...
    predictions: [
      {
        id: 'ts-pred-1',
        text: "The Brain is Still the \"Gold Standard\": This is his foundational argument. While he marvels at the progress in AI, he consistently points out how far it is from biological intelligence, especially in one key metric: energy efficiency. He predicts that a major hurdle for AI is its voracious energy consumption. The human brain performs incredible feats on about 20 watts of power; a comparable AI model requires megawatts in a data center. This isn't just a practical problem—he argues it points to a fundamental difference in computational principles that AI has yet to crack.",
        dateMade: new Date().toISOString(),
        topic: "The Core Philosophy (The Neurocentric View)",
      },
      {
        id: 'ts-pred-2',
        text: "Deep Learning is Successful Because It Is Brain-Like (to a degree): As a co-pioneer of the technology, Sejnowski doesn't see the success of deep learning as a purely mathematical or engineering fluke. He argues it works so well because it unwittingly captured key principles of brain organization, such as hierarchical processing layers. He predicts that the path to more powerful AI lies in taking more inspiration from neuroscience, not less.",
        dateMade: new Date().toISOString(),
        topic: "The Core Philosophy (The Neurocentric View)",
      },
      {
        id: 'ts-pred-3',
        text: "The Two-Way Street of Discovery: He predicts a virtuous cycle between AI and neuroscience.\n\to\tAI -> Neuroscience: AI models will serve as powerful testbeds for theories about the brain. We can experiment on an AI in ways we can't on a living brain to understand how things like memory, attention, or learning might work.\n\to\tNeuroscience -> AI: Discoveries about the brain's \"algorithms\" (e.g., how it handles credit assignment, consolidates memories during sleep, or uses reward systems) will provide the blueprints for the next generation of more capable and efficient AI architectures.",
        dateMade: new Date().toISOString(),
        topic: "The Core Philosophy (The Neurocentric View)",
      },
      {
        id: 'ts-pred-4',
        text: "We Will Reverse-Engineer More Brain Mechanisms for AI: He predicts that future breakthroughs will come from modeling specific brain systems that current AI lacks. This includes:\n\to\tSleep: Simulating the function of sleep for memory consolidation and preventing catastrophic forgetting in neural networks.\n\to\tNeuromodulators: Incorporating models of chemicals like dopamine and acetylcholine to create more flexible and context-aware learning systems (e.g., knowing when to learn quickly vs. slowly).\n\to\tSubcortical Structures: Moving beyond models of just the cortex to include the functions of the hippocampus (episodic memory), amygdala (emotional valence), and cerebellum (motor control).",
        dateMade: new Date().toISOString(),
        topic: "Scientific and Technical Predictions",
      },
      {
        id: 'ts-pred-5',
        text: "LLMs are a \"Cerebral Cortex in a Jar\": This is his brilliant characterization of today's models. He acknowledges their incredible power but sees them as an isolated component. They have the pattern-matching ability of the cortex but lack the grounding, memory, and value systems provided by the rest of the brain and a physical body. He predicts that integrating LLMs with other brain-inspired architectures will be the next major step.",
        dateMade: new Date().toISOString(),
        topic: "Scientific and Technical Predictions",
      },
      {
        id: 'ts-pred-6',
        text: "The \"Connectome\" Will Inspire New Architectures: Sejnowski is deeply involved in the BRAIN Initiative, which aims to map the brain's complete wiring diagram (the connectome). He predicts that as we gain a clearer picture of the brain's complex connectivity, we will discover new architectural motifs—like specific patterns of long-range connections or sparse wiring—that can be used to build more powerful and efficient AI systems.",
        dateMade: new Date().toISOString(),
        topic: "Scientific and Technical Predictions",
      },
      {
        id: 'ts-pred-7',
        text: "The Real Risk is Sociological and Neuro-Manipulative: He is less concerned with a superintelligence \"waking up\" and more concerned with how existing AI is already being used to exploit the reward pathways of the human brain. He predicts the major dangers are:\n\to\tAddiction and Manipulation: Social media and recommendation algorithms creating dopamine-driven feedback loops that are hard to escape.\n\to\tPolitical Polarization: AI systems learning to feed us content that confirms our biases and drives us to more extreme views.\n\to\tErosion of Trust: The proliferation of deepfakes and misinformation creating a world where our brains can no longer easily distinguish truth from falsehood.",
        dateMade: new Date().toISOString(),
        topic: "Stance on Risk and Society (Grounded in Biology)",
      },
      {
        id: 'ts-pred-8',
        text: "The Greatest Benefit is Curing the Brain: As a neuroscientist, this is his optimistic vision. He predicts that AI's most profound and positive impact will be in helping us understand and cure brain disorders. By modeling diseases like Alzheimer's, schizophrenia, and depression, AI will provide the tools to develop targeted therapies and interventions for conditions that have plagued humanity for millennia.",
        dateMade: new Date().toISOString(),
        topic: "Stance on Risk and Society (Grounded in Biology)",
      },
    ],
  ...
  },
  {
    ...
    predictions: [
      {
        id: 'ffl-pred-1',
        text: "Human-Centered AI is a Moral and Technical Imperative: This is her most important and consistent message. She argues that AI should not be developed in a vacuum. It must be designed from the outset to augment and enhance human capabilities, not replace them. She predicts that the most successful and beneficial AI will be that which respects human values like dignity, well-being, agency, and equity. This isn't an afterthought; it's a design principle.",
        dateMade: new Date().toISOString(),
        topic: "The Core Philosophy (The Human-Centered Approach)",
      },
      {
        id: 'ffl-pred-2',
        text: "The \"North Star\" of AI Should Be Enhancing Human Potential: Li predicts that the greatest achievements of AI will not be in creating artificial general intelligence, but in helping solve humanity's biggest problems. Her \"North Star\" vision involves using AI to empower doctors to heal, teachers to educate, scientists to discover, and artists to create. The goal is human flourishing.",
        dateMade: new Date().toISOString(),
        topic: "The Core Philosophy (The Human-Centered Approach)",
      },
      {
        id: 'ffl-pred-3',
        text: "Intelligence is Embodied, Interactive, and Social: Moving beyond her work in 2D images, Li emphasizes that real-world intelligence is not passive pattern recognition. It's active and requires understanding a 3D world, interacting with it, and collaborating with people. She predicts that the next major breakthroughs will come from AI systems that can perceive and act in complex human environments.",
        dateMade: new Date().toISOString(),
        topic: "The Core Philosophy (The Human-Centered Approach)",
      },
      {
        id: 'ffl-pred-4',
        text: "The Next Frontier is \"Spatial Intelligence\" and Ambient Computing: This is her key technical prediction. The AI revolution started with pixels on a screen (ImageNet), but she believes its future lies in our physical spaces. She predicts the rise of ambient AI: intelligent sensors and systems embedded in our environments (hospitals, homes, factories) that can understand human activities, intentions, and needs. This \"spatial intelligence\" will be the engine for the next generation of robotics and human assistance.",
        dateMade: new Date().toISOString(),
        topic: "Predictions on Technology and its Applications",
      },
      {
        id: 'ffl-pred-5',
        text: "Healthcare Will Be AI's Most Transformative Application: This is her primary focus area. She predicts that ambient intelligence will revolutionize healthcare, particularly in elder care and hospitals.\n\to\tSmart Hospitals: AI sensors will monitor patients for subtle signs of distress (like a potential fall or worsening condition), alert clinicians, and help reduce medical errors.\n\to\tDignified Aging: In-home sensors will help older adults live independently for longer by monitoring their well-being and providing assistance without intrusive cameras.\n\to\tClinician Augmentation: AI will handle administrative tasks, freeing up doctors and nurses to spend more time on direct patient care.",
        dateMade: new Date().toISOString(),
        topic: "Predictions on Technology and its Applications",
      },
      {
        id: 'ffl-pred-6',
        text: "Data Remains the Fuel, but Requires Careful Curation and Context: As the creator of ImageNet, no one knows the power of data better. However, she predicts a shift in focus from simply big data to high-quality, diverse, and contextually rich data. She also emphasizes the immense ethical responsibility that comes with collecting data, especially the sensitive data required for ambient intelligence in healthcare, demanding robust privacy and security measures.",
        dateMade: new Date().toISOString(),
        topic: "Predictions on Technology and its Applications",
      },
      {
        id: 'ffl-pred-7',
        text: "The Primary Risks are Societal, Not Hypothetical or Existential: Li is not focused on \"Terminator\" scenarios. She predicts the most immediate and pressing dangers are those we are already grappling with:\n\to\tAlgorithmic Bias: Systems trained on biased data perpetuating and amplifying social injustices.\n\to\tJob Displacement: The economic disruption caused by automating tasks.\n\to\tErosion of Privacy: The risks associated with ambient sensors collecting vast amounts of personal data.\n\to\tHuman Dignity: The danger of creating systems that devalue human labor and decision-making.",
        dateMade: new Date().toISOString(),
        topic: "Stance on Risk and Society (A Call for Collaborative Governance)",
      },
      {
        id: 'ffl-pred-8',
        text: "The Solution is Radical, Multidisciplinary Collaboration: This is her powerful call to action. She predicts that these complex societal problems cannot be solved by technologists alone. The only way forward is to bring humanists, social scientists, ethicists, policymakers, artists, and lawyers to the design table alongside engineers. The Stanford HAI was created to embody this principle. She advocates for a new generation of \"bilingual\" leaders who are fluent in both technology and the humanities.",
        dateMade: new Date().toISOString(),
        topic: "Stance on Risk and Society (A Call for Collaborative Governance)",
      },
    ],
