...
export const expertiseIcons: { [key: string]: React.ElementType } = {
  ...
  'Default': Sparkles,
  'Neural Networks': Layers, // Added for more specific DL
  ...
  'GPU Technology': Layers, // For Jensen Huang
  'Democratizing AI': Users, // For Hugging Face
...
export const experts: Expert[] = [
  ...
  // The "Godfathers" & Foundational Pioneers
  {
    id: '7',
  ...
  // Prominent Voices in AI Ethics, Safety & Policy
  {
    id: '88',
    name: 'Timnit Gebru',
  ...
  // More Key Contributors & Rising Stars
  {
    id: '102',
    name: 'Noam Brown',
